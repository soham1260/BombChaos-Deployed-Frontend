/**
 * @file LobbyScreen.jsx
 * @description Pre-game lobby: player slots, character picker, ready toggles, chat, host start.
 */
...
export default function LobbyScreen() {
    ...
    function handleLeave() {
        ...
        resetAll();
        // resetAll sets screen to 'landing'; override to keep user on landing (not login)
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {player.rating != null && (
                                                    <span className="text-xs text-yellow-400 font-mono ml-auto">⭐ {player.rating}</span>
                                                )}
                                            </div>
