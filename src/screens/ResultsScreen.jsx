...
export default function ResultsScreen() {
    ...
    function handleMainMenu() {
        ...
        resetAll();
        // Stay on landing (not login) — user is still authenticated
        setScreen('landing');
    }
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {/* Rating delta */}
                                            <span className={`text-xs font-mono ml-auto font-bold ${
                                                player.won ? 'text-green-400' : 'text-red-400'
                                            }`}>
                                                {player.won ? `+${RATING_DELTA}` : `-${RATING_DELTA}`} ⭐
                                            </span>
                                        </div>
                                    </div>
